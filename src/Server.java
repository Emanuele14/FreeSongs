                    ...
                    if (command.equalsIgnoreCase("quit")) {
                        ...
                        for (int i = 0; i < songs.size(); i++) {
                            ...
                            if (r == 0) {// poichè il compareTo delle stringhe torna zero se sono nella stessa posizione
                                ...
                                System.out.println("    >>>ClientManager:Song " + titolo + "of" + autore+" is removed ");
                            }
                        ...
                        System.out.println("    >>>ClientManager:operation in progress ->save");
                        Thread.sleep(1000);
                        Saver savingFile = new Saver();
                        Thread S= new Thread(savingFile);
                        S.start();
                        Thread.sleep(1000);
                        System.out.println("    >>>ClientManager: Stored successful ");
